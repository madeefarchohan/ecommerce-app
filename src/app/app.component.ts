import { TrackordersPage } from './../pages/trackorders/trackorders';
...
export class MyApp {
  ...
  loadHomePage() {
    ...
    this.storage.get('firsttimeApp').then((val) => {
      let value = val;
      console.log(this.config.showIntroPage);
  ...
  openPage(page) {
    ...
    else if (page == 'trackorders') this.nav.setRoot(TrackordersPage);
    ...
    else if (page == 'bankDetails') this.nav.setRoot(BankDetailsPage);
